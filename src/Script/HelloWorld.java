...
@Script.Manifest(name="Hello World!", description = "How's it going?", properties = "author=afds; topic=999; client=4;")


public class HelloWorld extends PollingScript<ClientContext> {

    final int GOBLIN_IDS[]={3030,3031,3029,3032,3033,3034,3035};
    final int FOOD_ID = 315;
    ...
    public void poll() {
        ...
        final double testing = Math.random();
