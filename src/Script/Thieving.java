...
@Script.Manifest(name="Theiving", description = "How's it going?", properties = "author=afds; topic=999; client=4;")

public class Thieving extends PollingScript<ClientContext> {
